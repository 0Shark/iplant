    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-6">  
          <div class="form">
            ...
            <hr>
             <?php
              $con = mysqli_connect("localhost","id12250873_iplant","juledelmer", "id12250873_register") or die ("could not connect to mysql");                           
  ...
  <div class="container">
    <div class="col-md-10 col-md-offset-1 section-title text-center">
      ...
      <?php
        ...
        $db2 = mysqli_connect("localhost", "id12250873_iplant2", "juledelmer", "id12250873_image_upload");
